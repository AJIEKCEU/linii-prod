...
"use strict";$((function(){var e,t,a=$("html").attr("lang"),s={searchText:"Поиск...",noMatch:'Ничего не найдено "{0}"',locale:["OK","Отмена","Выбрать все"],captionFormat:"{0} Выбрано",captionFormatAllSelected:"{0} Все выбраны!",langDates:{days:["Воскресенье","Понедельник","Вторник","Среда","Четверг","Пятница","Суббота"],daysShort:["Вос","Пон","Вто","Сре","Чет","Пят","Суб"],daysMin:["Вс","Пн","Вт","Ср","Чт","Пт","Сб"],months:["Январь","Февраль","Март","Апрель","Май","Июнь","Июль","Август","Сентябрь","Октябрь","Ноябрь","Декабрь"],monthsShort:["Янв","Фев","Мар","Апр","Май","Июн","Июл","Авг","Сен","Окт","Ноя","Дек"],today:"Сегодня",clear:"Очистить",dateFormat:"dd.mm.yyyy",timeFormat:"hh:ii",firstDay:1},fancybox:{CLOSE:"Закрыть",NEXT:"Дальше",PREV:"Назад",ERROR:"Запрошенный контент не может быть загружен. <br/> Попробуйте позже.",PLAY_START:"Начать слайдшоу",PLAY_STOP:"Остановить слайдшоу",FULL_SCREEN:"Полный экран",THUMBS:"Плиткой",DOWNLOAD:"Скачать",SHARE:"Поделиться",ZOOM:"Увеличить"}},n={searchText:"Search...",noMatch:'No matches for "{0}"',locale:["OK","Cancel","Select All"],captionFormat:"{0} Selected",captionFormatAllSelected:"{0} all selected!",langDates:{days:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],daysShort:["Su","Mo","Tu","We","Th","Fr","Sa"],daysMin:["Su","Mo","Tu","We","Th","Fr","Sa"],months:["January","February","March","April","May","June","July","August","September","October","November","December"],monthsShort:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],today:"Today",clear:"Clear",dateFormat:"dd.mm.yyyy",timeFormat:"hh:ii",firstDay:1},fancybox:{CLOSE:"Close",NEXT:"Next",PREV:"Previous",ERROR:"The requested content cannot be loaded. <br/> Please try again later.",PLAY_START:"Start slideshow",PLAY_STOP:"Pause slideshow",FULL_SCREEN:"Full screen",THUMBS:"Thumbnails",DOWNLOAD:"Download",SHARE:"Share",ZOOM:"Zoom"}};switch(a){case"ru":t={ru:(e=s).fancybox};break;default:t={en:(e=n).fancybox}}var o={win:$(window),body:$("body"),nav:$(".nav"),header:$(".header"),footer:$(".footer"),btnMenu:$(".js-toggle-menu"),mSlider:$(".main__slider"),shadowMenu:$(".nav-shadow"),scrollableElement:document.querySelector(".menu"),eventMenu:function(){var e=o.win.width();o.nav.toggleClass("nav--open"),o.btnMenu.toggleClass("js-toggle-menu--active"),o.shadowMenu.toggleClass("nav-shadow--active"),o.nav.hasClass("nav--open")&&e<1200?scrollLock.disablePageScroll(o.scrollableElement):scrollLock.enablePageScroll(o.scrollableElement)},selectSearch:function(){$(".js-select:not(.js-select--no-search)").SumoSelect({search:!0,searchText:e.searchText,noMatch:e.noMatch,locale:e.locale,captionFormat:e.captionFormat,captionFormatAllSelected:e.captionFormatAllSelected})},selectNoSearch:function(){$(".js-select--no-search").SumoSelect({search:!1})}};$(".text table, .table-style").wrap('<div class="table-wrp"></div>'),svg4everybody(),o.btnMenu.on("click",(function(){o.eventMenu()})),o.shadowMenu.on("click",(function(){o.eventMenu()})),o.body.on("click",".menu__link-wrp",(function(e){o.win.width()<1199&&"A"!==e.target.tagName&&(e.preventDefault(),$(this).hasClass("show-submenu")?$(".menu__link-wrp").removeClass("show-submenu").stop(!0).next(".submenu").slideUp():($(".menu__link-wrp").removeClass("show-submenu").stop(!0).next(".submenu").slideUp(),$(this).addClass("show-submenu").stop(!0).next(".submenu").slideDown()))})),o.body.on("click",".submenu__link-wrp",(function(e){if(o.win.width()<1199&&"A"!==e.target.tagName){e.preventDefault();var t=$(this).closest(".submenu");$(this).hasClass("show-submenu")?t.find(".submenu__link-wrp").removeClass("show-submenu").next(".submenu").stop(!0).slideUp():(t.find(".submenu__link-wrp").removeClass("show-submenu").next(".submenu").stop(!0).slideUp(),$(this).addClass("show-submenu").next(".submenu").stop(!0).slideDown())}}));var l=0,r=1;function i(e,t){var a,s=0,n='<div class="form-message form-message--error">Заполните обязательные поля!</div>',o=t||!1,l=$(e),r=l.data("ajax"),i=l.find('input[type="email"].chk'),c=i.val();if(l.find(".form-message").remove(),l.find(".chk").each((function(){var e=$(this);e.val()?(e.hasClass("inputfile")&&e.closest(".file").removeClass("file_err"),e.removeClass("err"),e.next(".selected").removeClass("err")):(e.hasClass("inputfile")&&e.closest(".file").addClass("file_err"),e.addClass("err"),l.find(".form-message").remove(),o.after(n),s=1)})),i.length&&(a=c,new RegExp(/^(("[\w-\s]+")|([\w-]+(?:\.[\w-]+)*)|("[\w-\s]+")([\w-]+(?:\.[\w-]+)*))(@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$)|(@\[?((25[0-5]\.|2[0-4][0-9]\.|1[0-9]{2}\.|[0-9]{1,2}\.))((25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\.){2}(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\]?$)/i).test(a)?i.removeClass("err"):(i.addClass("err"),l.find(".form-message").remove(),o.after(n),s=1)),0===s){if(void 0!==r){l.find("[type=submit]").prop("disabled",!0);var d=new FormData(l.get(0));return!1!==o&&d.append(o.attr("name"),o.val()),$.ajax({type:"POST",url:r,data:d,processData:!1,contentType:!1,dataType:"html",success:function(e){l.find(".form-message").remove(),l.find("[type=submit]").prop("disabled",!1),"Y"===(d=JSON.parse(e)).result?(l.find('input:not([type="submit"],[type="hidden"]),textarea').val(""),o.after(d.html)):o.after(d.html)}}),!1}return l.find(".form-message").remove(),!0}return l.find(".form-message").remove(),o.after(n),!1}o.win.scroll((function(){var e=o.win.scrollTop(),t=(o.win.outerWidth(),$(this).scrollTop());!function(e,t,a,s){0!==e?(a>l&&e>=s?r&&(r=0,o.header.stop(!0).animate({top:-s},300,(function(){$(this).addClass("header--fixed compensate-for-scrollbar")}))):r||(r=1,o.header.stop(!0).animate({top:"1rem"},300)),l=a):(r=1,o.header.stop(!0).animate({top:"1rem"},300,(function(){$(this).removeClass("header--fixed compensate-for-scrollbar")})))}(e,0,t,o.header.outerHeight()+8),t>$(this).height()?$(".js-up").addClass("js-up_show"):$(".js-up").removeClass("js-up_show")})),o.win.scroll(),$(".js-up").on("click",(function(){$("body,html").animate({scrollTop:0},700)})),o.body.on("click",".js-accordion",(function(){$(this).toggleClass("js-accordion__ttl_active").next(".js-accordion__info").stop(!0).slideToggle()})),new Swiper(".slider",{autoplay:{delay:8e3,disableOnInteraction:!1},pagination:{el:".slider-pagination",type:"fraction"},navigation:{nextEl:".slider-button__next",prevEl:".slider-button__prev"},spaceBetween:0,effect:"fade",fadeEffect:{crossFade:!1},speed:1e3,loop:!0}),$("[data-fancybox]").fancybox({lang:a,i18n:t,animationEffect:"fade"}),o.body.on("click",".js-popup-lnk",(function(e){e.preventDefault(),$.fancybox.open({src:$(this).attr("href"),opts:{buttons:!1,smallBtn:!1,touch:!1,animationEffect:"fade",afterClose:function(){$('.modal input:not([type="submit"]),.modal textarea').removeClass("err"),$(".modal .err_mess,.modal .complete").remove()}}})})),o.body.on("click",".js-ajax-lnk",(function(e){e.preventDefault(),$.fancybox.open({src:$(this).attr("href"),type:"ajax",opts:{buttons:!1,smallBtn:!1,touch:!1,animationEffect:"fade"}})})),o.selectSearch(),o.selectNoSearch(),$(".js-phone-mask").mask("+375 (99) 999-99-99"),o.body.on("click",".js-tabs-lnk",(function(e){e.preventDefault();var t=$(this),a=t.closest(".js-tabs-wrp"),s=a.find(".js-tabs-lnk"),n=a.find(".js-tab"),o=t.attr("href");s.removeClass("js-tabs-lnk_active"),a.find('.js-tabs-lnk[href="'+o+'"]').addClass("js-tabs-lnk_active"),n.removeClass("js-tab_show"),(n=$(o)).addClass("js-tab_show")})),o.body.on("click",".file__info",(function(){$("input",this.parentNode).click()})),o.body.on("change",".inputfile",(function(){var e=$(this),t=e.closest(".file-wrapper"),a=t.find(".file__path"),s=t.find(".file__del"),n=a.attr("data-nofile"),o=e.val(),l=o.replace("C:\\fakepath\\","");""!==o?(a.text(l),s.addClass("show")):(a.text(n),s.removeClass("show"))})),o.body.on("click",".file__del",(function(){var e=$(this).closest(".file-wrapper"),t=e.find(".file__path"),a=t.attr("data-nofile"),s=e.find(".file__del");e.find(".inputfile").val(""),t.text(a),s.removeClass("show")})),o.body.on("change, keyup",'input:not([type="file"],input:not([type="submit"],[type="hidden"]),textarea',(function(){var e=$(this);e.hasClass("err")&&e.val()&&e.removeClass("err")})),o.body.on("submit","form",(function(e){if(void 0===$(this).attr("data-ajax"))return i(this);e.preventDefault()})),o.body.on("click","[type = submit]",(function(){return i($(this).closest("form"),$(this))})),window.vaObj=o}));