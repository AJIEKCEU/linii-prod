...
"use strict";$((function(){var e,t,s=$("html").attr("lang"),n={searchText:"Поиск...",noMatch:'Ничего не найдено "{0}"',locale:["OK","Отмена","Выбрать все"],captionFormat:"{0} Выбрано",captionFormatAllSelected:"{0} Все выбраны!",fancybox:{CLOSE:"Закрыть",NEXT:"Дальше",PREV:"Назад",ERROR:"Запрошенный контент не может быть загружен. <br/> Попробуйте позже.",PLAY_START:"Начать слайдшоу",PLAY_STOP:"Остановить слайдшоу",FULL_SCREEN:"Полный экран",THUMBS:"Плиткой",DOWNLOAD:"Скачать",SHARE:"Поделиться",ZOOM:"Увеличить"}};switch(s){case"ru":default:t={ru:(e=n).fancybox}}var a={win:$(window),body:$("body"),nav:document.querySelector(".nav"),header:$(".header"),btnMenu:document.querySelector(".js-toggle-menu"),mSlider:$(".main__slider"),shadowMenu:document.querySelector(".nav-shadow"),scrollableElement:document.querySelector(".menu"),eventMenu:function(){var e=window.screen.width;a.nav.classList.toggle("nav--open"),a.btnMenu.classList.toggle("js-toggle-menu--active"),a.shadowMenu.classList.toggle("nav-shadow--active"),a.nav.classList.contains("nav--open")&&e<1200?scrollLock.disablePageScroll(a.scrollableElement):scrollLock.enablePageScroll(a.scrollableElement)},selectSearch:function(){$(".js-select").SumoSelect({search:!0,searchText:e.searchText,noMatch:e.noMatch,locale:e.locale,captionFormat:e.captionFormat,captionFormatAllSelected:e.captionFormatAllSelected})},selectNoSearch:function(){$(".js-select-no-search").SumoSelect({search:!1})}};a.selectSearch(),a.selectNoSearch(),a.btnMenu.onclick=function(e){a.eventMenu()},a.shadowMenu.onclick=function(e){a.eventMenu()},a.body.on("click",".menu__link-wrp",(function(e){a.win.width()<1199&&"A"!==e.target.tagName&&(e.preventDefault(),$(this).hasClass("show-submenu")?$(".menu__link-wrp").removeClass("show-submenu").stop(!0).next(".submenu").slideUp():($(".menu__link-wrp").removeClass("show-submenu").stop(!0).next(".submenu").slideUp(),$(this).addClass("show-submenu").stop(!0).next(".submenu").slideDown()))})),a.body.on("click",".submenu__link-wrp",(function(e){if(a.win.width()<1199&&"A"!==e.target.tagName){e.preventDefault();var t=$(this).closest(".submenu");$(this).hasClass("show-submenu")?t.find(".submenu__link-wrp").removeClass("show-submenu").next(".submenu").stop(!0).slideUp():(t.find(".submenu__link-wrp").removeClass("show-submenu").next(".submenu").stop(!0).slideUp(),$(this).addClass("show-submenu").next(".submenu").stop(!0).slideDown())}}));var o=0,i=1;function r(e,t){var s,n=0,a='<div class="form-message form-message--error">Заполните обязательные поля!</div>',o=t||!1,i=$(e),r=i.data("ajax"),l=i.find('input[type="email"].chk'),c=l.val();if(i.find(".form-message").remove(),i.find(".chk").each((function(){var e=$(this);e.val()?(e.hasClass("inputfile")&&e.closest(".file").removeClass("file_err"),e.removeClass("err"),e.next(".selected").removeClass("err")):(e.hasClass("inputfile")&&e.closest(".file").addClass("file_err"),e.addClass("err"),i.find(".form-message").remove(),o.after(a),n=1)})),l.length&&(s=c,new RegExp(/^(("[\w-\s]+")|([\w-]+(?:\.[\w-]+)*)|("[\w-\s]+")([\w-]+(?:\.[\w-]+)*))(@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$)|(@\[?((25[0-5]\.|2[0-4][0-9]\.|1[0-9]{2}\.|[0-9]{1,2}\.))((25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\.){2}(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\]?$)/i).test(s)?l.removeClass("err"):(l.addClass("err"),i.find(".form-message").remove(),o.after(a),n=1)),0===n){if(void 0!==r){i.find("[type=submit]").prop("disabled",!0);var u=new FormData(i.get(0));return!1!==o&&u.append(o.attr("name"),o.val()),$.ajax({type:"POST",url:r,data:u,processData:!1,contentType:!1,dataType:"html",success:function(e){i.find(".form-message").remove(),i.find("[type=submit]").prop("disabled",!1),"Y"===(u=JSON.parse(e)).result?(i.find('input:not([type="submit"],[type="hidden"]),textarea').val(""),o.after(u.html)):o.after(u.html)}}),!1}return i.find(".form-message").remove(),!0}return i.find(".form-message").remove(),o.after(a),!1}a.win.scroll((function(){var e=a.win.scrollTop(),t=(a.win.outerWidth(),$(this).scrollTop());!function(e,t,s,n){0!==e?(s>o&&e>=n?i&&(i=0,a.header.stop(!0).animate({top:-n},300,(function(){$(this).addClass("header--fixed")}))):i||(i=1,a.header.stop(!0).animate({top:"1rem"},300)),o=s):(i=1,a.header.stop(!0).animate({top:"1rem"},300,(function(){$(this).removeClass("header--fixed")})))}(e,0,t,a.header.outerHeight()+8),t>$(this).height()?$(".js-up").addClass("js-up--is-show"):$(".js-up").removeClass("js-up--is-show")})),a.win.scroll(),$(".js-up").on("click",(function(){$("body,html").animate({scrollTop:0},700)})),a.body.on("click",".js-accordion",(function(){$(this).toggleClass("js-accordion__ttl_active").next(".js-accordion__info").stop(!0).slideToggle()})),new Swiper(".slider",{autoplay:{delay:8e3,disableOnInteraction:!1},pagination:{el:".slider-pagination",type:"fraction"},navigation:{nextEl:".slider-button__next",prevEl:".slider-button__prev"},spaceBetween:0,effect:"fade",fadeEffect:{crossFade:!1},speed:1e3,loop:!0}),$("[data-fancybox]").fancybox({lang:s,i18n:t,animationEffect:"fade"}),a.body.on("click",".js-modal-link",(function(e){e.preventDefault(),$.fancybox.open({src:$(this).attr("href"),opts:{buttons:!1,smallBtn:!1,touch:!1,animationEffect:"fade",afterClose:function(){$('.modal input:not([type="submit"]),.modal textarea').removeClass("err"),$(".form-message").remove()}}})})),a.body.on("click",".js-ajax-lnk",(function(e){e.preventDefault(),$.fancybox.open({src:$(this).attr("href"),type:"ajax",opts:{buttons:!1,smallBtn:!1,touch:!1,animationEffect:"fade"}})})),$(".js-phone-mask").mask("+375 (99) 999-99-99"),a.body.on("change, keyup",'input:not([type="file"],input:not([type="submit"],[type="hidden"]),textarea',(function(){var e=$(this);e.hasClass("err")&&e.val()&&e.removeClass("err")})),a.body.on("submit","form",(function(e){if(void 0===$(this).attr("data-ajax"))return r(this);e.preventDefault()})),a.body.on("click","[type = submit]",(function(){return r($(this).closest("form"),$(this))})),window.vaObj=a}));